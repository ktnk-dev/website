...
function app_init(){return document.getElementsByTagName('body')[0].appendChild(document.createElement('app'))}
...
newqr.id = 'qr_code'
document.getElementsByTagName('body')[0].appendChild(newqr)
var qrc = new QRCode(document.getElementById("qr_code"), window.location.href )
function remove_qr(){document.getElementById('qr_code').remove()}